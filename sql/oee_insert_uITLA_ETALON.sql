...
(pgt.dtl_etalon_assy)a where test_dt between to_date(':inicio','yyyy-mm-dd hh24:mi') 
  and to_date(':final','yyyy-mm-dd hh24:mi')
  and facility in ('EN2'))a left join apogee.oee_machine_catalog b on system_id=machine 
